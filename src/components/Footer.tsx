      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-400">{about.role}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400">
                Full-stack developer with expertise in React.js, Node.js, and database management.
            ...
            <div>
              ...
              <p className="text-gray-400">
                Email: <a href={`mailto:${about.contactEmail}`} className="hover:text-white transition-colors">{about.contactEmail}</a>
              </p>
            </div>
          </div>
        </div>
